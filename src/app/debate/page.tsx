              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 p-4 rounded-md border border-blue-200">
                  ...
                  <div className="max-h-60 overflow-y-auto">
                    <p className="text-gray-800 whitespace-pre-wrap">{debateSummary.speaker1Transcript}</p>
                  </div>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-md border border-green-200">
                  ...
                  <div className="max-h-60 overflow-y-auto">
                    <p className="text-gray-800 whitespace-pre-wrap">{debateSummary.speaker2Transcript}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="w-1/5 bg-gray-800 rounded-lg shadow-md p-4 flex flex-col">
                  <div className="text-white text-center mb-4">
                    ...
                    <p className="text-sm text-gray-400">Speaker {currentSpeaker === 'speaker1' ? '1' : '2'} is active</p>
                  </div>
                ...
                <div className="w-4/5 bg-white rounded-lg shadow-md p-6">
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-bold text-blue-700">
                      {currentSpeaker === 'speaker1' ? 'Speaker 1' : 'Speaker 2'}
                    </h2>
